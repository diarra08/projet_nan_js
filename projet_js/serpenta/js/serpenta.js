...
function serpent_touch(evt){	
	// gestion du sens de deplacement en fonction des touches clavier
...
function serpent_bouge(evt){	
	//deplacement du serpent et du corp.
...
function rotanav(el,alpha){		
	//rotation des div en fonction du navigateur
...
function cadre_bord(){		
	//gestion de la position aux bords du div conteneur.

	var conteneur=document.getElementById('jeux');
...
function colision(){		
	//gestion de la colision entre la pomme et la tete
...
function colision_queue(param){		
	//gestion de la colision entre la tete et le corps
...
function crea_queue(){	
	...
	return(document.getElementById('jeux').appendChild(el));
}


function fin(){	
	// fin de partie; on vide les tableaux, arrete l'interval et affiche le menu.
	...
	var clone2=document.getElementById('point').cloneNode(true);
	document.getElementById('jeux').innerHTML='';
	document.getElementById('jeux').appendChild(clone2);
	document.getElementById('jeux').appendChild(clone);
...
function serpenta(){
	...
	for(var i=0;i < document.getElementById('jeux').offsetWidth; i+=k_serpent.taille_pixel){
		k_serpent.tb_grille_l.push(i);
	}
	
	for(var i=0;i < document.getElementById('jeux').offsetHeight; i+=k_serpent.taille_pixel){
